...
class People_Controller extends Base_Controller {
    ...
    public function action_addPost() {
        ...
        if ($v->passes()) {
            ...
            return Redirect::to('people/add')->with_input()->with_errors($v);
        }
    }
...
//        die('moo');
    ...
    public function action_detailsPost($person_id) {
        $input = Input::all();
        ...
        if (isset($input['save'])) {
            ...
            if ($v->passes()) {
                ...
                return Redirect::to('people/' . $person_id)->with_input()->with_errors($v);
            }
        // saved surgery
            ...
            if ($v->passes()) {
                Surgery::update($person_id, $input);
                return Redirect::to('people/' . $person_id)
    ...
    public function action_detailsGet($person_id) {
